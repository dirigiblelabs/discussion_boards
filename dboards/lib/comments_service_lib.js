...
exports.create = function(){
	var commentsDao = require("dboards/lib/comment_dao").create();
	var commentsSvc = rsdata.service(undefined, undefined, undefined, 'dboards.svc.CommentsService').dao(commentsDao);
