...
"use strict";
	...
	.service('SecureBoard', ['$resource', '$log', function($resource, $log) {
	  	return $resource('../../../js/dboards/svc/user/board.js/:boardId', { boardId:'@id' }, {
			    save: {
			        method: 'POST',
			        interceptor: {
	...
	.service('SecureBoardVote', ['$resource', function($resource) {
	  	return $resource('../../../js/dboards/svc/user/board.js/:boardId/vote', {}, 
	...
	.service('SecureBoardTags', ['$resource', function($resource) {
	  	return $resource('../../../js/dboards/svc/user/board.js/:boardId/tags', {}, 
	  			{
	...
	.service('$SecureComment', ['$resource', '$log', function($resource, $log) {
	 	return $resource('../../../js/dboards/svc/user/comment.js/:commentId', { commentId:'@id' }, {
			    save: {
			        method: 'POST',
			        interceptor: {
		                response: function(res) {
	...
	.service('$LoggedUser', ['$resource', function($resource) {
		var UserSvc =  $resource('../../../js/dboards/svc/user/user.js', {}, //$resource('../../js/profile/user.js', {}, 
	  					{get: {method:'GET', params:{}, isArray:false, ignoreLoadingBar: true}});
	  	var get = function(){
	...
	.service('$LoggedUserProfile', ['$resource', function($resource) {
		var UserSvc =  $resource('../../../js/dboards/svc/user/profile.js/logout', {}, 
	  					{get: {method:'GET', params:{}, isArray:false, ignoreLoadingBar: true}});
	  	var logout = function(){
		  	return UserSvc.get().$promise;
	  	};
