...
"use strict";
	...
	.service('SecureBoard', ['$resource', '$log', function($resource, $log) {
	  	return $resource('../../js-secured/discussion_boards/svc/user/board.js/:boardId', { boardId:'@id' }, {
			    save: {
			        method: 'POST',
			        interceptor: {
	...
	.service('SecureBoardVote', ['$resource', function($resource) {
	  	return $resource('../../js-secured/discussion_boards/svc/user/board.js/:boardId/vote', {}, 
	...
	.service('SecureBoardTags', ['$resource', function($resource) {
	  	return $resource('../../js-secured/discussion_boards/svc/user/board.js/:boardId/tags', {}, 
	  			{
	...
	.service('$SecureComment', ['$resource', '$log', function($resource, $log) {
	 	return $resource('../../js-secured/discussion_boards/svc/user/comment.js/:commentId', { commentId:'@id' }, {
			    save: {
			        method: 'POST',
			        interceptor: {
		                response: function(res) {
