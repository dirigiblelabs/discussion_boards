...
var BoardsDataService = function(){
	...
	var self = this;	
	this.boardVotes = require("discussion_boards/lib/board_votes_dao").get();
	this.boardTags = require("discussion_boards/lib/board_tags_dao").get();
	...
	var boardStatsDataService = require("discussion_boards/lib/board_stats_service_lib").get();
